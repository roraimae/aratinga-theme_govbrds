...
class BRBreadcrumb {
  ...
  /**
   * Atualiza a visualizaÃ§Ã£o do componente
   * @private
   */
  _setView() {
    this._reset()
...
class BRCarousel {
  constructor(name, component) {
     ...
     * @property {number} activeStageNum - NÃºmero do palco ativo
   ...
   * @param {number} activeStepNum - nÃºmero do passo
   */
   ...
   * @param {number} num - nÃºmero do palco
   */
  setActiveStage(num) {
  ...
  /**
   * Desabilita os botÃµes se o carousel nÃ£o for circular
   */
  disabledBtns() {
  ...
  /**
   * Muda a pÃ¡gina ativa incrementalmente - aÃ§Ãµes de botÃµes e swap
...
class CookiebarData {
  /**
   * Instancia um objeto de dados do cookiebar. Objeto contÃ©m as propriedades contidas no JSON de entrada em uma lÃ­ngua especÃ­fica
   * @param {string} json - JSON de entrada de dados
   * @param {string} lang - LÃ­ngua para filtrar o JSON de entrada
   */
  ...
  /**
   * Filtra um JSON pela lÃ­ngua correspondente
   * @param {string} json - Dados no formato JSON (array de objetos)
   * @param {string} lang - LÃ­ngua para filtrar o array vindo do json
   * @returns Objeto javascript contendo as propriedade vindas do JSON filtradas pela lÃ­ngua
   * @private
   */
  _filterByLang(json, lang) {
    ...
    if (data.length > 0) {
      ...
      return data[0] // Retorna o primeiro. Se existir mais objetos na mesma lÃ­ngua, os demais serÃ£o ignorados.
    } else {
      // NÃ£o existe dados na lingua especificada
  ...
  /**
   * Controla a configuraÃ§Ã£o do estado indeterminado dos checkboxes
   * @private
   */
  ...
  /**
   * Trata a configuraÃ§Ã£o do estado indeterminado dos checkboxes dos grupos de cookies
   * @private
   */
  ...
  /**
   * Trata a configuraÃ§Ã£o do estado indeterminado do checkbox geral
   * @private
   */
   ...
   * @param {function} callback - FunÃ§Ã£o de callback que recebe a conteÃºdo do arquivo
   * @public
   * @static
   */
...
class CookiebarLabels {
  ...
  /**
   * Trata a label para a informaÃ§Ã£o de atualizaÃ§Ã£o
   * @returns {string} - Label para a informaÃ§Ã£o de atualizaÃ§Ã£o
   * @public
   */
  setLastUpdateLabel() {
    return this.data.lastUpdateLabel || 'Ãšltima atualizaÃ§Ã£o'
  }

  /**
   * Trata a label para o tÃ­tulo da lista de grupos de cookies
   * @returns {string} - Label para o tÃ­tulo da lista de grupos de cookies
   * @public
   */
  ...
  /**
   * Trata a label para o domÃ­nio do cookie
   * @returns {string} - Label para o domÃ­nio do cookie
   * @public
   */
  setCookieDomainLabel() {
    return this.data.domainLabel || 'DomÃ­nio'
  }
  ...
  /**
   * Trata a label para a descriÃ§Ã£o do cookie
   * @returns {string} - Label para a descriÃ§Ã£o do cookie
   * @public
   */
  setCookieDescriptionLabel() {
    return this.data.descriptionLabel || 'DescriÃ§Ã£o'
  }

  /**
   * Trata a label para o botÃ£o de polÃ­ticas/definiÃ§Ãµes de cookies
   * @returns {string} - Label para o botÃ£o de polÃ­ticas/definiÃ§Ãµes de cookies
   * @public
   */
  setPoliticsButtonLabel() {
    return this.data.allOptOut
      ? this.data.optOutButton || 'Definir Cookies'
      : this.data.optInButton || 'Ver PolÃ­tica de Cookies'
  }

  /**
   * Trata a label para o botÃ£o de aceite
   * @returns {string} - Label para o botÃ£o de aceite
   * @public
   */
...
/** Classe que contÃ©m os templates do cookiebar */
class CookiebarTemplates {
  ...
  /**
   * Cria um template para a Ã¡rea de conteÃºdo global
   * @returns {string} - Elemento DOM que representa a Ã¡rea de conteÃºdo global
   * @public
   */
  ...
  /**
   * Cria um template para a Ã¡rea de conteÃºdo introdutÃ³rio
   * @returns {string} - Elemento DOM que representa a Ã¡rea de conteÃºdo introdutÃ³rio
   * @private
   */
  ...
  /**
   * Cria um template para a Ã¡rea de conteÃºdo principal
   * @returns {string} - Elemento DOM que representa a Ã¡rea de conteÃºdo principal
   * @private
   */
  _setMainContentArea() {
  ...
  /**
   * Cria um template para a Ã¡rea de acÃµes
   * @returns {string} - Elemento DOM que representa a Ã¡rea de aÃ§Ãµes
   * @private
   */
  _setActionArea() {
  ...
  /**
   * Cria um template para o tÃ­tulo principal
   * @returns {string} - Elemento DOM que representa o tÃ­tulo principal
   * @private
   */
  _setMainTitle() {
  ...
  /**
   * Cria um template para informaÃ§Ãµes sobre atualizaÃ§Ã£o
   * @returns {string} - Elemento DOM que representa a informaÃ§Ã£o sobre atualizaÃ§Ã£o
   * @private
   */
  _setLastUpdate() {
  ...
  /**
   * Cria um template para o texto introdutÃ³rio
   * @returns {string} - Elemento DOM que representa o texto introdutÃ³rio
   * @private
   */
  _setEntryText() {
  ...
  /**
   * Cria um template para o header da Ã¡rea de conteÃºdo principal
   * @returns {string} - Elemeto DOM que representa o header da Ã¡rea de conteÃºdo principal
   * @private
   */
  ...
  /**
   * Cria um template para a descriÃ§Ã£o do grupo de cookies
   * @param {object} groupData - Objeto com dados de 1 grupo de cookies
   * @returns {string} - Elemento DOM que representa a descriÃ§Ã£o do grupo de cookies
   * @private
   */
  ...
  /**
   * Cria um template para as informaÃ§Ãµes dos cookies
   * @param {object} groupData - Objeto com dados de 1 grupo de cookies
   * @param {number} groupIndex - Ãndice do grupo de cookies
   * @returns {string} - Elemento DOM que representa as informaÃ§Ãµes dos cookies
   * @private
   */
  ...
  /**
   * Cria um template para a lista de notificaÃ§Ãµes
   * @returns {string} - Elemento DOM que representa a lista de notificaÃ§Ãµes
   * @private
   */
  _setNotifications() {
    return `<hr>
  ...
  /**
   * Cria um template para as informaÃ§Ãµes das notificaÃ§Ãµes
   * @returns {string} - Elemento DOM que representa as informaÃ§Ãµes das notificaÃ§Ãµes
   * @private
   */
  ...
  /**
   * Cria um template para a Ã¡rea de conteÃºdo complementar
   * @returns {string} - Elemento DOM que representa a Ã¡rea de conteÃºdo complementar
   * @private
   */
  ...
  /**
   * Cria um templata para as informaÃ§Ãµes dos links
   * @returns {string} - Elemento DOM que representa as informaÃ§Ãµes dos links
   * @private
   */
  _setLinkInfo() {
    let linkTemplates = ''
  ...
  /**
   * Cria um template pra o botÃ£o de polÃ­ticas de cookies
   * @returns {string} - Elemento DOM que representa o botÃ£o de politicas de cookies
   * @private
   */
  _setPoliticsButton() {
  ...
  /**
   * Cria um template pra o botÃ£o de aceite
   * @returns {string} - Elemento DOM que representa o botÃ£o de aceite
   * @private
   */
  _setAcceptButton() {
  ...
  /**
   * Cria um template para o botÃ£o de fechar
   * @returns {string} - Elemento DOM que represeta o botÃ£o de fechar
   * @private
   */
  _setCloseButton() {
  ...
  /**
   * Cria um template para botÃ£o de abrir/fechar do brupo de cookies
   * @param {object} groupData - Objeto com dados de 1 grupo de cookies
   * @returns {string} - Elemento DOM que representa o botÃ£o de abrir/fechar do grupo de cookies
   * @private
   */
  ...
  /**
   * Cria um template para o checkbox de seleÃ§Ã£o geral
   * @returns {string} - Elemento DOM que representa o checkbox de seleÃ§Ã£o geral
   * @private
   */
  _setCheckAll() {
  ...
  /**
   * Cria um template para o checkbox de seleÃ§Ã£o do grupo de cookies
   * @param {object} groupData - Objeto com dados de 1 grupo de cookies
   * @param {number} groupIndex - Ãndice do grupo de cookies
   * @returns {string} - Elemento DOM que representa o checkbox de seleÃ§Ã£o do grupo de cookies
   * @private
   */
  ...
  /**
   * Cria um template para checkbox(switch) de seleÃ§Ã£o do cookie
   * @param {number} groupIndex - Ãndice do grupo de cookies
   * @param {object} cookieData - Objeto com dados de 1 cookie
   * @param {number} cookieIndex - Ãndice do cookie
   * @returns {string} - Elemento DOM que representa o checkbox(switch) de seleÃ§Ã£o do cookie
   * @private
   */
...
class BRCookiebar {
   ...
   * @property {string} name - Nome do componente em minÃºsculo (br-cookiebar)
   * @property {object} component - Objeto referenciando a raiz do componente DOM
   * @property {string} json - JSON de entrada com dados do cookiebar
   * @property {string} lang - Lingua para filtrar o JSON de entrada
   * @property {string} mode - Mode de renderizaÃ§Ã£o do cookibar ('default' | 'open')
   * @property {function} callback - Chamada no aceite do cookiebar com o JSON de saÃ­da como argumento
   */
  ...
  /**
   * Controla a instanciaÃ§Ã£o do cookiebar
   * @private
   */
  _setUp() {
  ...
  /**
   * Controla a construÃ§Ã£o do cookiebar com o uso de templates
   * @private
   */
  _buildCookiebar() {
  ...
  _setAccessibility() {
    ...
    this.component.setAttribute('aria-label', 'Componente para definiÃ§Ã£o de Cookies')
  }
  ...
  /**
   * Trata o comportamento do botÃ£o de aceite do cookiebar
   * @private
   */
  _setAcceptButtonBehavior() {
    ...
    // (NavegaÃ§Ã£o por teclado) MantÃ©m o foco no cookiebar quando ele estÃ¡ aberto
  ...
  /**
   * Trata o comportamento do botÃ£o de polÃ­ticas/definiÃ§Ãµes de cookies
   * @private
   */
  ...
  /**
   * Trata o comportamento do botÃ£o de fechar do cookiebar no modo open
   * @orivate
   */
  ...
  /**
   * Trata a responsividade de um botÃ£o de aÃ§Ã£o baseado na largura da tela
   * @param {object} button - Elemento DOM que representa um botÃ£o de aÃ§Ã£o
   * @private
   */
   ...
   * @param {number} groupIndex - Ãndice do grupo
   * @private
   */
  ...
  /**
   * Trata da seleÃ§Ã£o dos checkboxes
   * @private
   */
  ...
  /**
   * Handler para o evento change na seleÃ§Ã£o dos checkboxes
  ...
  /**
   * Trata a seleÃ§Ã£o do checkbox geral
  ...
  /**
   * Trata da seleÃ§Ã£o do checkbox de grupo
  ...
  /**
   * Trata da seleÃ§Ã£o do checkbox de cookie
   * @param {object} checkbox - Elemento DOM que represeta um checkbox de cookie
   * @param {number} groupIndex - Ãndice do grupo
   * @param {number} cookieIndex - Ãndicd do cookie dentro do grupo
   * @private
   */
  ...
  /**
   * Controla a apresentaÃ§Ã£o da mensagem geral
   * @private
   */
  ...
  /**
   * Controla a apresentaÃ§Ã£o da mensagem de grupo
   * @param {number} groupIndex - Ãndice do grupo
   * @private
   */
  ...
  /**
   * Controla a apresentaÃ§Ã£o da mensagem de cookie
   * @param {number} groupIndex - Ãndice do grupo
   * @param {number} cookieIndex - Ãndice do cookie dentro do grupo
   */
   ...
   * @returns {object} - Elemento DOM representando que contÃ©m uma determinada classe
   * @private
   */
   ...
   * @param {string} oldIcon - Classe do icone que serÃ¡ retirada
   * @param {string} newIcon - Classe do icone que serÃ¡ incluido
   * @private
   */
  ...
  /**
   * Configura a altura da parte rolÃ¡vel do cookiebar de acordo com a altura da janela
   * @private
   */
  _setOpenView() {
  ...
  /**
   * Cria o JSON de saÃ­da do cookiebar
   * @returns {string} - JSON de saÃ­da do cookiebar
   * @private
   */
  _setOutputJSON() {
    this.output = {}
...
const jsonData = `[
  {
    ...
    "selectAll": false,
    "allAlertMessage": "Ao desativar qualquer Cookie, sua navegaÃ§Ã£o poderÃ¡ ser comprometida",
    "closeLabel": "fechar tela de seleÃ§Ã£o de cookies",
    "lastUpdateLabel": "Ãšltima atualizaÃ§Ã£o",
    ...
    "cookieGroups": [
      {
        ...
        "groupText": "DescriÃ§Ã£o do Grupo de Cookies.",
        "cookieList": [
          {
            ...
            "description": "DescriÃ§Ã£o do Cookie"
          },
          {
      ...
      },
      {
        ...
        "groupOptOut": true,
        "groupSelected": false,
        "groupAlertMessage": "Ao desativar algum Cookie do Grupo ExperiÃªncia do site, sua navegaÃ§Ã£o ficarÃ¡ comprometida.",
        "groupText": "DescriÃ§Ã£o do Grupo de Cookies.",
        "cookieList": [
          {
            ...
            "cookieOptOut": true,
            "cookieSelected": false,
            "alertMessage": "Ao desativar o Cookie experiencia-1, sua navegaÃ§Ã£o ficarÃ¡ comprometida.",
            "cookieName": "optimizelyEndUserId",
            "expires": "30 minutos",
            "domain": "serpro.gov.br",
            "enterprise": "Serpro",
    ...
    "links": [
      {
        "name": "DeclaraÃ§Ã£o de Conformidade com os PrincÃ­pios de ProteÃ§Ã£o de Dados",
        "url": "#"
      }
    ]
  }
...
class BRDateTimePicker {
   ...
   * @param {string} name - Nome do componente em minÃºsculo
   * @param {object} component - Objeto referenciando a raiz do componente DOM
   * @param {string} config - atributo de configuraÃ§Ã£o do componente
   * @param {object} language arquivo de linguagem do flatpick por padrÃ£o nesse componente vem portugues
   */
  ...
  /**
   * Formata o componente e monta instÃ¢ncia flatpickr
   * @private
   */
...
class BRFooter {
  ...
  /**
   * Controla a configuraÃ§Ã£o inicial do footer
   */
  _setUp() {
  ...
  /**
   *Inclui Ã­cone 'fa-angle-up'
   * @param {objetc} iconComponent - Elemento DOM que representa um Ã­cone
   * @private
   */
  ...
  /**
   * Inclui Ã­cone 'fa-angle-down'
   * @param {object} iconComponent - Elemento DOM que representa um Ã­cone
   * @private
   */
...
class BRHeader {
   ...
   */
  _setDropdownBehavior() {
    // TODO: Trocar o cÃ³digo abaixo pelo utilitÃ¡rio dropdown
    this.cleaned = false
    let hideDrop
   ...
   * @private
   * @param {object} ref - ReferÃªncia ao componente header
   */
  ...
  /**
   * Foca no prÃ³ximo elmento de aÃ§Ã£o
   * @private
   */
  _nextFocusElement() {
    //lista de elementos de aÃ§Ã£o
...
class BRInput {
   ...
   * Define comportamentos do componente
   * @private
   * @param {event} event - referÃªncia ao elemento que dispara a aÃ§Ã£o
   */
   ...
   * Define comportamentos do teclado
   * @private
   * @param {event} event - referÃªncia ao elemento que dispara a aÃ§Ã£o do teclado
   */
...
class BRMenu {
  ...
  /**
   * Navega para o prÃ³ximo elemento na lista com base em um operador.
   *
   * @param {HTMLElement} element - O elemento de referÃªncia a partir do qual a navegaÃ§Ã£o serÃ¡ realizada.
   * @param {number} operator - Um operador numÃ©rico que indica a direÃ§Ã£o da navegaÃ§Ã£o.
   *                             Um valor positivo indica a navegaÃ§Ã£o para baixo, enquanto um valor negativo
   *                             indica a navegaÃ§Ã£o para cima.
   */
  _navigateToNextElment(element, operator) {
    // ObtÃ©m o contÃªiner pai com base na hierarquia
    ...
    // ObtÃ©m todos os elementos irmÃ£os relacionados ao elemento de referÃªncia dentro do contÃªiner pai
    ...
    // Determina a posiÃ§Ã£o do elemento de referÃªncia na lista de elementos irmÃ£os
    const posicao = Array.from(elementSiblings).findIndex((el) => {
      return el === element
    })

    // Calcula a nova posiÃ§Ã£o na lista com base no operador
    const soma = posicao + operator

    // Foca no prÃ³ximo elemento na lista, ajustando para o inÃ­cio ou o final da lista se necessÃ¡rio
    if (soma >= 0 && soma < elementSiblings.length) {
      ...
      // Se a nova posiÃ§Ã£o estiver fora dos limites, foca no primeiro ou no Ãºltimo elemento da lista, dependendo do operador
    ...
    if (trigger) {
      trigger.addEventListener('keydown', (event) => {
        if (event.code === 'Enter' || event.code === 'Space') {
          event.preventDefault() // Impede o comportamento padrÃ£o do botÃ£o Enter ou Space
  ...
  /**
   *  Focar no primeiro item de nÃ­vel 1 visÃ­vel
   * @private
   */
  _focusOnFirstVisibleItem() {
    ...
    if (activeMenu) {
      activeMenu.focus()
      activeMenu.scrollIntoView({ block: 'nearest' }) // Foca e traz para a visualizaÃ§Ã£o se necessÃ¡rio
      return
    }
    ...
    if (firstVisibleItem) {
      ...
      firstVisibleItem.scrollIntoView({ block: 'nearest' }) // Foca e traz para a visualizaÃ§Ã£o se necessÃ¡rio
    }
  }
  ...
  _setDropMenu() {
    for (const item of this.component.querySelectorAll('.menu-folder > a.menu-item')) {
      ...
      //Configura aria indicando que submenu estÃ¡ fechado
  ...
  /**
   * Gerencia eventos de cliques e interaÃ§Ãµes por teclado no menu - tecla espaÃ§o
   * @private
   * @param {object} element - referÃªncia ao Objeto que farÃ¡ a aÃ§Ã£o
   */
  ...
  /**
   * Gerencia eventos de cliques e interaÃ§Ãµes por teclado no Side Menu - tecla espaÃ§o
   * @private
   * @param {object} element - referÃªncia ao Objeto que farÃ¡ a aÃ§Ã£o
   */
  _handleSideMenuInteraction(element) {
    // Verifica se o elemento jÃ¡ possui click listener atravÃ©s de um atributo especial
    if (!element.hasAttribute('data-click-listener')) {
      element.addEventListener('click', () => {
        this.inSubmenu = false
   ...
   * @private
   * @param {object} element - referencia ao Objeto que farÃ¡ a aÃ§Ã£o
   */
  _hideItems(element) {
   ...
   * @private
   * @param {object} element - referÃªncia ao Objeto pai
   * @param {string} icon - nome da classe font awesome do Ã­cone
   */
  _createIcon(element, icon) {
    // Verifica se jÃ¡ existe container para o Ã­cone
   ...
   */
  _addARIAAttributes() {
    // Adiciona atributo role="menubar" Ã  classe .menu-body
    ...
    // Adiciona atributo role="group" nos elementos .menu-item que sÃ£o filhos de .menu-folder e nÃ£o sÃ£o drop-down
    ...
    // Adiciona atributo role="menuitem" somente aos elementos <a> com a classe .menu-item que nÃ£o tÃªm .menu-folder como pai
    ...
    // Adiciona atributo role="menu" e aria-label nos elementos <ul> que sÃ£o filhos de .side-menu
    ...
    // Adiciona atributo role="menu" e aria-label nos elementos <ul> que sÃ£o filhos de .menu-folder
...
class BRNotification {
   ...
   * @private
   * @property {object} action - ReferÃªncia ao Objeto que dispara a aÃ§Ã£o
   */
  ...
  /**
   * Define tooltip para a notificaÃ§Ã£o
   * @private
   */
   ...
   * @private
   * @property {object} componente - ReferÃªncia ao Objeto
   */
  _dismiss(component) {
...
class BRPagination {
  ...
  /**
   * Cria aÃ§Ã£o de clique na pÃ¡gina
   * @private
   */
  _setActive() {
  ...
  /**
   * Cria aÃ§Ã£o de clique no dropdown
...
class BRSelect {
   ...
   * @property {string} name - Nome do componente em minÃºsculo
   * @property {object} component - Objeto referenciando a raiz do componente DOM
   * @property {string} notFound - (Opcional) String contendo cÃ³digo html para informar que a busca nÃ£o encontrou nenhuma opÃ§Ã£o.
   *                                Se nÃ£o informado, serÃ¡ usado um cÃ³digo html padrÃ£o.
   */
  ...
  /**
   * Remove o elemento que indica item nÃ£o encontrado
   * @private
   */
  ...
  /**
   * Coloca o texto Item nÃ£o encontrado no select
   * @private
   */
  _addNotFoundElement() {
    const image =
      ...
      <div class="br-item not-found">
        <div class="container pl-0 pr-0">
          <div class="row">
            ...
            <div class="col">
              <p>NÃ£o encontramos o que vocÃª estÃ¡ procurando!</p>
            </div>
          </div>
        </div>
      </div>
  ...
  _prepareComponent() {
    ...
    listElement.setAttribute('aria-label', 'Lista de OpÃ§Ãµes')
  ...
  /**
   * Retorna posiÃ§Ã£o do elemento no select
   * @param {element} component elemento que vai ser pesquisado
   * @returns {integer} valor da posiÃ§Ã£o
   */
  ...
  /**
   * Define comportamentos na seleÃ§Ã£o
   * @private
   */
  _setSelectionBehavior() {
  ...
  /**
   * retira comportamento  de clique na seleÃ§Ã£o
   * @private
   */
   ...
   * @param {integer} index PosiÃ§Ã£o do elemento na lista
  ...
  /**
   * ObtÃ©m o tamanho em pixels de um valor de texto.
   *
  ...
  /**
   * Retorna uma string contendo elementos de um array atÃ© o limite de caracteres especificado.
   * Se houver elementos truncados, a quantidade de elementos truncados Ã© indicada no final da string.
   *
   * @param {Array<string>} array - O array de elementos.
   * @param {number} maxCharacterCount - O limite mÃ¡ximo de caracteres permitidos na string resultante.
   * @returns {string} - A string contendo os elementos atÃ© o limite de caracteres, com indicaÃ§Ã£o de elementos truncados, se houver.
   */
  ...
  /**
   * Retorna a quantidade mÃ¡xima de caracteres de um elemento de input antes do overflow.
   *
   * @param {HTMLElement} input - O elemento de input.
   * @returns {number} A quantidade mÃ¡xima de caracteres antes do overflow.
   */
  ...
  /**
   * Retorna a largura mÃ©dia de um caractere dentro de um elemento de input.
   *
   * @param {HTMLElement} input - O elemento de input.
   * @returns {number} A largura mÃ©dia de um caractere.
   */
   ...
   * @param {HTMLElement} input - O elemento de input usado como referÃªncia para o tamanho mÃ¡ximo.
...
class BRStep {
  constructor(name, component) {
    ...
    /**
     * Retorna o nÃ³ pai do elemento com o nome da classe especÃ­fica
     * @param {object} elem - ReferÃªncia ao elemento
     * @param {string} parentClass - Nome da classe pai
     * @returns {object} ReferÃªncia ao elemento pai
     */
    ...
    /** Retorna o nÃºmero do passo de referencia
     * @param {object} elem - ReferÃªncia ao botÃ£o de passo
     * @returns {number} NÃºmero do passo
     */
    this.getActiveStep = (elem) => {
      return Array.from(this.DOMstrings.stepsBtns).indexOf(elem)
    }

    /** Define o nÃºmero do passo de referÃªncia como ativo
     * @param {number} num - numero do passo de referÃªncia
     */
    ...
    /**
     * Mostra os nÃºmeros dos rÃ³tulos dos passos
     */
    this.setStepsNum = () => {
      this.DOMstrings.stepsBtns.forEach((elem, index) => {
    ...
    /** Testa se o passo estÃ¡ dentro do escopo e o define como ativo
...
class BRTab {
   ...
   * @param {event} event - evento que disparou a aÃ§Ã£o
   */
  ...
  /**
   * Define o deslocamento da posiÃ§Ã£o ativa
   * @property {object} target - referencia ao objeto DOM
   * @property {number} direction - incremento Ã  posiÃ§Ã£o
   */
  ...
  /**
   * Define o deslocamento da posiÃ§Ã£o ativa do tab-item interno
   * @property {object} target - referencia ao objeto DOM
   * @property {number} direction - incremento Ã  posiÃ§Ã£o
   */
  ...
  /**
   * Define o deslocamento da posiÃ§Ã£o ativa do elemento referenciado
   * @property {object} target - referencia ao objeto DOM
   * @property {number} direction - incremento Ã  posiÃ§Ã£o
  ...
  /**
   * Define a posiÃ§Ã£o ativa do elemento referenciado
   * @property {object} target - referencia ao objeto DOM
   */
  setPosition(target) {
    let contComponent = 0
...
class BRTable {
   ...
   * @param {string} name - Nome do componente em minÃºsculo
   * @param {object} component - Objeto referenciando a raiz do componente DOM
   * @param {number} sequence - 'Ã­ndice do componente para sobreposiÃ§Ã£o'
   */
  ...
  /**
   * Configura largura do cabeÃ§alho
   * @private
   */
  _setHeaderWidth() {
  ...
  _searchBehavior() {
    if (this.component.dataset.search) {
      ...
      if (trigger && target && dismiss && inputField) {
        ...
        console.error('Um ou mais elementos necessÃ¡rios para a busca nÃ£o foram encontrados.')
      }
    }
  }
   ...
   * Inicializa a busca
   * @private
   * @param {object} trigger - Objeto referente ao elemento que dispara a aÃ§Ã£o
   */
  _searchInit(trigger) {
   ...
   * @private
   * @param {object} trigger - Objeto referente ao elemento que dispara a aÃ§Ã£o
   * @param {object} target - Objeto referente ao alvo da aÃ§Ã£o
   */
  ...
  /**
   * Define visualizaÃ§Ã£o dos itens selecionados na barra contextual
   * @private
   * @param {number} count - nÃºmero de itens selecionados
   * @param {object} selectedBar - Objeto referente a barra contextual
   * @param {object} tableCheckboxes - Objeto referente a lista de checkboxes
   * @param {object} headerCheckbox - Objeto referente ao checkbox do header
   */
...
class BRTag {
   ...
   * @private
   * @param {object} input - referencia DOM ao input
   * @param {event} event - aÃ§Ã£o que disparou o evento
   */
  ...
  /**
   * Define comportamento do botÃ£o de fechar usando classe (compatibilidade)
   * @private
   */
  _closeTag() {
  ...
  /**
   * Define comportamento do botÃ£o de fechar usando data-dismiss
   * @private
   */
  _dismissTag() {
  ...
  updateAssist() {
    ...
    if (!this.characters && this.limit) {
      if (characterCount === 0 && this.limit.innerHTML === '') {
        this.limit.innerHTML = `<span aria-live="polite">Limite mÃ¡ximo de <strong >${this.maximum}</strong> caracteres</span>`
...
class BRUpload {
  ...
  /**
   * Evita os eventos padrao e propagaÃ§Ã£o de evento
   * @private
   * @param {event} event - referencia ao evento
   */
  ...
  /**
   * Testa se o objeto que disparou a aÃ§Ã£o estÃ¡ desabilitado
   * @private
   * @param {event} event - referencia ao evento
   */
  _isDisabled(event) {
  ...
  /**
   * Simula aÃ§Ã£o de clicar no input
   * @private
   */
  _clickUpload() {
  ...
  _handleFiles(files) {
    ...
    if (!this._inputElement.multiple && files.length > 1) {
      this._feedback('danger', 'Ã‰ permitido o envio de somente 1 arquivo.')
    } else if (!this._inputElement.multiple && this._fileArray.length > 0) {
      this._fileArray = []
      this._concatFiles(files)
      this._updateFileList()
      this._feedback('warning', 'O arquivo enviado anteriormente foi substituÃ­do')
    } else {
      this._concatFiles(files)
      this._updateFileList()
    }
  ...
  /**
   * Atualiza lista de arquivos eliminando redundÃ¢ncias
   * @private
   */
  _updateFileList() {
    this._removeStatus()
   ...
   * @private
   * @param {Number} position - numero do Ã­nidice da posiÃ§Ã£o
   */
   ...
   * @private
   * @param {Number} index - numero do Ã­nidice da posiÃ§Ã£o
   * @param {event} event - evento que disparou a aÃ§Ã£o
   */
...
class BRWizard {
  ...
  constructor(name, component) {
    ...
    /**
     * Retorna o elemento pai do objeto com a classe de referÃªncia
     * @param {object} elem - Lista de objetos
     * @param {string} parentClass - nome da classe de referÃªncia
     * @returns {object}
     */
    this.findParent = (elem, parentClass) => {
      let currentNode = elem
    ...
    /**
     * Retorna o Ã­ndice do elemento botÃ£o de passo
     * @param {object} elem - botÃ£o de passo
     * @returns {number}
     */
    this.getActiveStep = (elem) => {
      return Array.from(this.DOMstrings.stepsBtns).indexOf(elem)
    ...
    /**
     * Define o estado do botÃ£o ativo e limpa os demais estados dos botÃµes
     * @param {number} activeStepNum - nÃºmero do botÃ£o ativo
     */
    ...
    /**
     * Move o focus para o primeiro elemento na Ã¡rea de conteÃºdo do wizard que tenha o tabindex igual ou maior que 0
     * @param {number} actualNumber - nÃºmero do passo ativo
    ...
    /**
     * Retorna o Ã­ndice do painel ativo
     * @returns {number}
     */
    this.getActivePanel = () => {
      let activePanel
  ...
  _setBehavior() {
    ...
    /**
     * Mapeia clique nos botÃµes de navegaÃ§Ã£o
     */
 ...
 * O Comportamento Accordion Ã© um agrupador de comportamentos Collapse
 */
class Accordion extends _collapse__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  /**
   * Trata a configuraÃ§Ã£o inicial do comportamento accordion
   * @private
   */
  _setUp() {
    super._setUp()
  ...
  /**
   * ObtÃ©m todos os acionadores pertencentes ao grupo do comportamento accordion
 ...
 *
 * Cada checkbox parent em uma cadeia de checkbox terÃ¡ um objeto prÃ³prio para tratar
 * o seu comportamento e de seus filhos. Os eventListeners sÃ£o declarados em cada objeto,
 * de modo que a execuÃ§Ã£o passa por objetos diferentes quando um checkbox Ã© pai e filho ao mesmo tempo
 *
 * O comportamento Ã© uma sincronia entre os eventos e o objeto que executa o evento
 */
class Checkgroup {
  /**
   ...
   * @type {string} - O valor do atributo data-checked-label ou o valor da label, caso nÃ£o tenha o atributo
   * @readonly
   * @public
   */
  get checkedLabel() {
   ...
   * @type {string} - O valor do atributo data-unchecked-label ou o valor da label, caso nÃ£o tenha o atributo
   * @readonly
   * @public
   */
  get uncheckedLabel() {
   ...
   * @param {string} tag - Nome que indica a relaÃ§Ã£o entre checkbox pai e checkbox filho
  ...
  /**
   * Trata o estado indeterminado no evento click da etapa de interaÃ§Ã£o do usuÃ¡rio
   * @private
   */
  ...
  /**
   * Verifica se todos os checkboxes filhos estÃ£o selecionados
   * @returns {boolean} - true se todos os checkboxes filhos estÃ£o selecionados
   *                      false se pelo menos 1 checkbox filho nÃ£o estÃ¡ selecionado
   * @private
   */
  ...
  /**
   * Verifica se todos so checkboxes filhos estÃ£o desselecionados
   * @returns {boolean} - true se todos os checkboxes filhos estÃ£o desselecionados
   *                      false se pelo menos 1 checkbox filho estÃ¡ selecionado
   * @private
   */
...
class Collapse {
  ...
  _focusOnFirstItem(target) {
    ...
    if (firstItem) {
      firstItem.scrollIntoView({ block: 'nearest' }) // Foca e traz para a visualizaÃ§Ã£o se necessÃ¡rio
    }
  }
...
class Scrim {
   ...
   * @property {boolean} limitTabKey - Impede a navegaÃ§Ã£o via tab fora da modal
   */
  ...
  /**
   * Alterna o estado de visualizaÃ§Ã£o do comportamento scrim
   * @private
   */
  showScrim() {
    if (this.trigger) {
...
class Tooltip {
   ...
   * @param {object} - Objeto de configuraÃ§Ã£o inicial para tooltip
   ...
   * @property {string} textTooltip - Texto que vai ser mostrado quando nÃ£o estiver instaciado o atributo component
   * @property {string} type - Tipo de tooltip (info, warning) padrÃ£o info
   * @property {boolean} onActivator - Adiciona o tooltip dentro do elemento ativador padrÃ£o false
   */
  ...
  _setContent(contentText, type) {
    ...
    //TODO: Retirar sample que utiliza nÃ£o conflita com tooltip componente que estÃ¡ sendo depreciado
...
// Script Templates
 ...
 // dados para instanciaÃ§Ã£o do cookiebar
...
class Globals {
  ...
  initInstanceCookiebar() {
    /** Exemplo de instanciaÃ§Ã£o de um objeto cookiebar */
    const cookiebarList = []
    ...
    /** Exemplo de instanciaÃ§Ã£o do cookibar apenas sem necessidade de um HTML base */
